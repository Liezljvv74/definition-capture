...
/**
 * The collections a list's filter should offer.
 *
 ...
 * Phrases offered all eight default collections and every one of them led to
 ...
 * that is where a collection is chosen for the first time and has to exist
 ...
 *
 * Names are folded to compare and kept as written to display, so a collection
...
export function collectionOptions(
  items: readonly { collections: string[] }[],
  selected: string,
